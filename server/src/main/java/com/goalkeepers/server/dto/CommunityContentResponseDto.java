...
@NoArgsConstructor
@Builder
public class CommunityContentResponseDto {
    ...
    public static CommunityContentResponseDto of(PostContent postContent, Goal goal, String nickname, boolean isLike, String imageUrl) {
        boolean isGoal = Objects.nonNull(goal);
        return CommunityContentResponseDto.builder()
